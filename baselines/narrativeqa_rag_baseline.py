...
Usage:
    python baselines/narrativeqa_rag_baseline.py
    python baselines/narrativeqa_rag_baseline.py "Your query here"
    python baselines/narrativeqa_rag_baseline.py --interactive
"""
